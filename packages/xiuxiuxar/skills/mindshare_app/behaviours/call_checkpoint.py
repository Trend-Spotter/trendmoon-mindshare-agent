...
class CallCheckpointRound(BaseState):
    ...
    def _finalize_checkpoint_check(self) -> None:
        ...
        # Note: period_count is now managed by CheckStakingKPIRound which reads directly from FSM
        # and saves it to state.json. This ensures the saved value is always synchronized with FSM.
