...
class TestTechnicalIndicators(BaseSkillTestCase):  # noqa: PLR0904
    ...
    def test_validate_ohlcv_data_valid(self):
        ...
        self.data_collection_round._validate_ohlcv_data(self.valid_ohlcv_data)  # noqa: SLF001
    ...
    def test_validate_ohlcv_data_empty_list(self):
        ...
        with pytest.raises(ValueError, match="ohlcv_data must be a non-empty list of lists"):
            self.data_collection_round._validate_ohlcv_data([])  # noqa: SLF001

    def test_validate_ohlcv_data_not_list(self):
        """Test _validate_ohlcv_data with non-list input."""
        with pytest.raises(ValueError, match="ohlcv_data must be a non-empty list of lists"):
            self.data_collection_round._validate_ohlcv_data(None)  # noqa: SLF001

        with pytest.raises(ValueError, match="ohlcv_data must be a non-empty list of lists"):
            self.data_collection_round._validate_ohlcv_data("invalid")  # noqa: SLF001
    ...
    def test_validate_ohlcv_data_invalid_row_format(self):
        ...
        with pytest.raises(ValueError, match="Each row must be a list with at least 6 elements"):
            self.data_collection_round._validate_ohlcv_data(invalid_data)  # noqa: SLF001
    ...
    def test_preprocess_ohlcv_data_success(self):
        ...
        result = self.data_collection_round._preprocess_ohlcv_data(self.valid_ohlcv_data)  # noqa: SLF001
    ...
    def test_preprocess_ohlcv_data_with_invalid_numbers(self):
        ...
        result = self.data_collection_round._preprocess_ohlcv_data(data_with_nans)  # noqa: SLF001
    ...
    def test_calculate_trend_indicators(self):
        ...
        data = self.data_collection_round._preprocess_ohlcv_data(self.valid_ohlcv_data)  # noqa: SLF001

        with (
            patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.sma") as mock_sma,
            patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.ema") as mock_ema,
        ):
    ...
    def test_calculate_momentum_indicators(self):
        ...
        with (
            patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.rsi") as mock_rsi,
            patch.object(self.data_collection_round, "_process_macd_indicator") as mock_macd,
            patch.object(self.data_collection_round, "_process_adx_indicator") as mock_adx,
        ):
            ...
            self.data_collection_round._calculate_momentum_indicators(data)  # noqa: SLF001
    ...
    def test_process_macd_indicator_success(self):
        ...
        with patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.macd", return_value=mock_macd_df):
            self.data_collection_round._process_macd_indicator(data)  # noqa: SLF001
    ...
    def test_process_macd_indicator_none_result(self):
        ...
        with patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.macd", return_value=None):
            self.data_collection_round._process_macd_indicator(data)  # noqa: SLF001
    ...
    def test_process_macd_indicator_empty_result(self):
        ...
        with patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.macd", return_value=empty_df):
            self.data_collection_round._process_macd_indicator(data)  # noqa: SLF001
    ...
    def test_process_adx_indicator_success(self):
        ...
        with patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.adx", return_value=mock_adx_df):
            self.data_collection_round._process_adx_indicator(data)  # noqa: SLF001
    ...
    def test_process_adx_indicator_none_result(self):
        ...
        with patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.adx", return_value=None):
            self.data_collection_round._process_adx_indicator(data)  # noqa: SLF001
    ...
    def test_calculate_volatility_indicators_success(self):
        ...
        with patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.bbands", return_value=mock_bb_df):
            self.data_collection_round._calculate_volatility_indicators(data)  # noqa: SLF001
    ...
    def test_calculate_volatility_indicators_none_result(self):
        ...
        with patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.bbands", return_value=None):
            self.data_collection_round._calculate_volatility_indicators(data)  # noqa: SLF001
    ...
    def test_calculate_volume_indicators_success(self):
        ...
        with (
            patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.obv", return_value=mock_obv),
            patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.cmf", return_value=mock_cmf),
        ):
            self.data_collection_round._calculate_volume_indicators(data)  # noqa: SLF001
    ...
    def test_calculate_volume_indicators_none_results(self):
        ...
        with (
            patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.obv", return_value=None),
            patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.cmf", return_value=None),
        ):
            self.data_collection_round._calculate_volume_indicators(data)  # noqa: SLF001
    ...
    @patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.rsi")
    @patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.macd")
    @patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.adx")
    @patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.bbands")
    @patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.obv")
    @patch("packages.xiuxiuxar.skills.mindshare_app.behaviours.ta.cmf")
